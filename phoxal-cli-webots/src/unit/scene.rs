...
use phoxal_utils_component::v1::capability::{Capability as PhysicalCapability, StructuralTarget};
...
use crate::unit::support::urdf::convert_joint_type;
use crate::unit::{metadata, proto_name};
            ...
            .map(|(component_id, model_component)| {
                ...
                Ok((
                    ...
                    ComponentProtoInstance {
                        proto_name: proto_name(&model_component.component)?,
                        capability_names,
...
pub struct RuntimeComponentBinding {
    ...
    pub physical: phoxal_utils_component::v1::capability::Capability,
