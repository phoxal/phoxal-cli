...
- Adopt runtime v2 and durable world-first simulation ([#351](https://github.com/phoxal/phoxal-cli/pull/351)) [**breaking**]
...
- Do not start attachment feeds a one-shot command never reads ([#347](https://github.com/phoxal/phoxal-cli/pull/347))
...
- Enable the robot target so a reboot brings the runtimes back ([#335](https://github.com/phoxal/phoxal-cli/pull/335))
...
- Install a release whose graph is up, not only one whose graph is complete ([#333](https://github.com/phoxal/phoxal-cli/pull/333))
...
- Make a systemd install actually come up ([#331](https://github.com/phoxal/phoxal-cli/pull/331))
...
- Split phoxal from phoxald around finalized bundles and execution-scoped Zenoh ([#297](https://github.com/phoxal/phoxal-cli/pull/297)) [**breaking**]
  ...
  The CLI now ships two executables that install and upgrade as one exact pair.
  `phoxal` builds projects, publishes the finalized bundle, and attaches a
  terminal session; `phoxald` supervises one execution and owns the robot's
  Zenoh router. The finalized `robot.yaml` is the only persisted robot
  definition, every bus key is rooted at the execution, and the private resident
  socket protocol is gone in favour of the typed supervisor API.
...
- *(supervisor)* Fail the session when the embedded router goes away ([#281](https://github.com/phoxal/phoxal-cli/pull/281))
...
- *(project)* Rebaseline framework train to 0.45.4


## [0.30.2](https://github.com/phoxal/phoxal-cli/releases/tag/v0.30.2) - 2026-08-01
...
## [0.29.3](https://github.com/phoxal/phoxal-cli/releases/tag/v0.29.3) - 2026-07-31
...
## [0.29.2](https://github.com/phoxal/phoxal-cli/releases/tag/v0.29.2) - 2026-07-31
...
## [0.28.6](https://github.com/phoxal/phoxal-cli/releases/tag/v0.28.6) - 2026-07-29
...
## [0.28.5](https://github.com/phoxal/phoxal-cli/releases/tag/v0.28.5) - 2026-07-29
...
## [0.28.4](https://github.com/phoxal/phoxal-cli/releases/tag/v0.28.4) - 2026-07-29
