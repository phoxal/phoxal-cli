...
- `phoxal-simulator-webots-controller` reads staged Webots PROTO metadata; host tools fetch source-shaped bundle assets such as `model.yaml` and component configs through the robot asset query service.
