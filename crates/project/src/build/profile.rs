...
impl StagingBuild {
    pub(crate) const fn host_runtime() -> Self {
        Self::HostRuntime
    }
    ...
    /// The object-file signature every binary in this release must match.
    pub(crate) fn expected_target(&self) -> Result<ExpectedTarget> {
        match self {
