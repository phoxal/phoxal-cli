...
//!
//! The field is written with the fully-qualified `v1::drive::Target`
//! path rather than through a `use phoxal_api::v1 as api;` alias: the
...
//! `contract` string come out version-qualified (`"v1::drive::Target"`)
...
#[allow(dead_code)]
struct Api {
    target: Publisher<phoxal_api::v1::drive::Target>,
}
